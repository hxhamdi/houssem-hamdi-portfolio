...
class FirestoreSeeder {
  ...
  Future<void> seedSocialLinks() async {
    ...
    print('Social links seeded successfully');
  }
  ...
  Future<void> seedProjects() async {
    final projects = [
      Project(
        ...
        techStack: const ['Flutter', 'ESP32', 'Firebase', 'C/C++'],
      ...
      Project(
        ...
        techStack: const ['ESP32', 'FreeRTOS', 'AssemblyAI', 'Firebase'],
      ...
      Project(
        ...
        techStack: const ['Flutter', 'Provider', 'Firebase'],
        url: '',
        demoUrl: '',
  ...
  Future<void> seedExperience() async {
    final experience = [
      ...
      Experience(
        ...
        techStack: const ['Flutter', 'ESP32', 'Azure'],
        url: '',
        type: 'education',
        order: 4,
      ),
      Experience(
        ...
        techStack: const ['Node.js', 'Angular', 'WebSockets', 'Express'],
        url: '',
        type: 'work',
        order: 5,
      ),
      Experience(
        ...
        techStack: const ['Machine Learning', 'IoT', 'Model Checking'],
        url: '',
        type: 'education',
        order: 6,
      ),
      Experience(
        ...
        description: '',
        details: const [],
        techStack: const ['Java', 'Algorithms', 'Data Structures'],
        url: '',
        type: 'education',
        order: 7,
      ),
  ...
  Future<void> seedCV() async {
    ...
    print('CV metadata seeded successfully');
  }
  ...
  Future<void> _clearCollection(String collectionPath) async {
    ...
    print('Collection $collectionPath cleared successfully');
  }
}
